...
## Что оценивается
1. Используется инкапсуляция.
2. Корректное описание данных в классе.
3. Наличие конструктора в классе.
...
## Что оценивается
1. Используется полиморфизм.
2. Наличие интерфейсов.
3. Корректное описание данных в классе.
4. Наличие конструктора в классах.
